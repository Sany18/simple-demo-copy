...
import { Inflate } from './other/inflate.module.min.js';
import { NURBSCurve } from './other/NURBSCurve.js';
...
var FBXLoader = ( function () {
	...
	function generateTransform( transformData ) {
		...
		if ( inheritType === 0 ) {
			...
			lParentLSM_inv.getInverse(lScalingM);
		...
		lRotationPivotM_inv.getInverse( lRotationPivotM );
		var lScalingPivotM_inv = new Matrix4();
		lScalingPivotM_inv.getInverse( lScalingPivotM );
